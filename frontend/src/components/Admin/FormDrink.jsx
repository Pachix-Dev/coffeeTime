      ...
      >
        {({
          ...
          <>
            ...
            <div className='upload-image-wrapper mb-3'>
              <div
                style={isDragging ? { backgroundColor: '#929ca6' } : undefined}
                {...dragProps}
                className={props?.images?.length === maxNumber ? 'd-none' : 'upload-image__click-drog'}
