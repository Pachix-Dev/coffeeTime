...
import { deleteDrink, fetchDrinks, getPostsError, getPostsStatus, selectAllPosts } from '../../features/drinks/drinkSlice'
      ...
      <Container className='mt-5 pt-5'>
          ...
          <tbody>
            {
              drinks.map(drink => {
                ...
                return (
                  <tr key={id}>
                    <td>
                      <img src={image} className='img-drink' /> {title}
                    </td>
                    <td>{ingredients}</td>
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>
              ¿Deseas eliminar {deleteDrink?.title}?
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            ¿Seguro(a) que quieres eliminar {deleteDrink?.title}? Esta acción no puede deshacerse.
          </Modal.Body>
          <Modal.Footer>
